...
namespace Sample
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Info info = new Info();
            info.Uri = phoneCallDialog.RemoteUri;
            info.From = phoneCallDialog.From;
            info.To = phoneCallDialog.To;
            info.CallID = phoneCallDialog.CallID;
            info.ContentType = "message/isup";
            info.Body = "51a6324134527";
