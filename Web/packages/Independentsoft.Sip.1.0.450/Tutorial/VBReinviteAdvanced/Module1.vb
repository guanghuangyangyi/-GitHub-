...
Module Module1
    ...
    Public Sub Main(ByVal args() As String)
        ...
        Dim reinvite As Invite = New Invite
        reinvite.Uri = phoneCallDialog.RemoteUri
        reinvite.CallID = phoneCallDialog.CallID
        reinvite.From = phoneCallDialog.From
        reinvite.To = phoneCallDialog.To
        reinvite.Contact = phoneCallDialog.Contact
        reinvite.ContentType = "application/sdp"
        reinvite.Body = session.ToString()

        Dim reinviteRequestResponse As RequestResponse = client.SendRequest(reinvite)
        client.Ack(reinviteRequestResponse)
